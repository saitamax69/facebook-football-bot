#!/usr/bin/env python3
"""Value Bet Post Script - Runs at 12:00 and 15:00 UTC"""
import sys
import os
...
def main(post_number):
    ...
    try:
        ...
        print("\n🔍 Analyzing...")
        match, analysis = analyzer.find_value_bet_match(fixtures)
        ...
        print("\n📝 Generating post...")
        post = gen.generate_value_bet_post(match, analysis, post_number)
